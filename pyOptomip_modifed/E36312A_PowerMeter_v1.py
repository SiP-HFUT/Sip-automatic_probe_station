...
class InstrumentConnection:
    ...
    def measure_voltage_power(self, start_voltage, end_voltage, step_voltage, delay, file_name, slot_no, ave_t):
...
if __name__ == '__main__':
    ...
    voltages, currents, powerE, powers = conn.measure_voltage_power(10, 1, -1, 0.001, filename, slot_no, average_time)
